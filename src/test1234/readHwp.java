	...
	public static void main(String[] args) throws IOException {
		...
		if (file.exists()) {
			...
			for(int i=0; i<Allquestion.size(); i++){
				...
				System.out.println("Q"+Allquestion.get(i));
				System.out.println(Allex1.get(i));
				System.out.println(Allex2.get(i));
				System.out.println(Allex3.get(i));
				System.out.println(Allex4.get(i));
				System.out.println("");
